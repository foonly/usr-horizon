...
During the early 2400:s Hollenbach and another scientist named Evan Pogge tried to enlarge the capacity of the wormhole. They managed to send matter through it, even in quite large quantities, but all the matter sent through came out as very small dust-like particles. This in itself was quite useful as mining operations could send minerals through the gate. Pogge however became quite obsessed with getting matter through the gate in its original form and eventually came up with an intricate way to create a field that neutralized the destructive forces of travel through the wormhole. He named the device "The Pogge Field Generator", but the name never stuck. It became known simply as the Jump Core.
...
Eventually systems either restored contact with their neighbours, or sent out explorers and gate ships to new systems.
